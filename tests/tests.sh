...

{
    ...
    try rearranged-sequence-clumps -s4 -c0 alns.maf
    ...
    try rearranged-sequence-clumps -n2 -s4 -c0 alns.maf mito.maf
    ...
    try rearranged-sequence-clumps -d200 -s3 -tC -c0 alns.maf
} 2>&1 |
